...
var adapter_1 = adapter.RTCPeerConnection;
var adapter_2 = adapter.RTCIceCandidate;
var adapter_3 = adapter.RTCSessionDescription;
var adapter_4 = adapter.getUserMedia;
var adapter_5 = adapter.attachMediaStream;
var adapter_6 = adapter.reattachMediaStream;
var adapter_7 = adapter.webrtcDetectedBrowser;
var adapter_8 = adapter.webrtcDetectedVersion;
var adapter_9 = adapter.webrtcMinimumVersion;
var adapter_10 = adapter.webrtcTesting;
var adapter_11 = adapter.webrtcUtils;
...
var node_1 = node.log;
var node_2 = node.formatArgs;
var node_3 = node.save;
var node_4 = node.load;
var node_5 = node.useColors;
var node_6 = node.colors;
...
var node_1$1 = node$1.log;
var node_2$1 = node$1.formatArgs;
var node_3$1 = node$1.save;
var node_4$1 = node$1.load;
var node_5$1 = node$1.useColors;
var node_6$1 = node$1.colors;
...
var debug = node$1('socket.io-parser');
...
var node_1$2 = node$2.log;
var node_2$2 = node$2.formatArgs;
var node_3$2 = node$2.save;
var node_4$2 = node$2.load;
var node_5$2 = node$2.useColors;
var node_6$2 = node$2.colors;

var debug$2 = createCommonjsModule(function (module) {
/**
 * Detect Electron renderer process, which is node, but we should
 * treat as a browser.
 */
...
var debug$3 = debug$2('engine.io-client:polling');
...
var debug$4 = debug$2('engine.io-client:polling-xhr');
...
try {
  ...
  bufferUtil = BufferUtil_fallback;
}

var BufferUtil$1 = bufferUtil.BufferUtil || bufferUtil;
...
Sender.prototype.frameAndSend = function(opcode, data, finalFragment, maskData, compressed, cb) {
  ...
  if (maskData) {
    ...
    if (mergeBuffers) {
      BufferUtil$1.mask(data, mask, outputBuffer, dataOffset, dataLength);
      try {
      ...
      BufferUtil$1.mask(data, mask, data, 0, dataLength);
      try {
...
Sender.prototype.applyExtensions = function(data, fin, compress, callback) {
  ...
  this.extensions[PerMessageDeflate_1.extensionName].compress(data, fin, callback);
};
...
try {
  isValidUTF8 = utf8Validate;
} catch (e) {
  isValidUTF8 = Validation_fallback;
}

var Validation$1 = typeof isValidUTF8 === 'object'
...
function Receiver (extensions,maxPayload) {
  ...
  this.fragmentedBufferPool = new BufferPool_1(1024, function(db, length) {
  ...
  this.unfragmentedBufferPool = new BufferPool_1(1024, function(db, length) {
    return db.used + length;
  }, function(db) {
...
Receiver.prototype.unmask = function (mask, buf, binary) {
  if (mask != null && buf != null) BufferUtil$1.unmask(buf, mask);
...
Receiver.prototype.applyExtensions = function(messageBuffer, fin, compressed, callback) {
  var self = this;
  if (compressed) {
    this.extensions[PerMessageDeflate_1.extensionName].decompress(messageBuffer, fin, function(err, buffer) {
      if (self.dead) return;
      if (err) {
...
function Sender$1(socket) {
  if (this instanceof Sender$1 === false) {
    throw new TypeError("Classes can't be function-called");
  }
...
var Sender_hixie = Sender$1;

/**
 * Inherits from EventEmitter.
 */

util.inherits(Sender$1, events.EventEmitter);
...
Sender$1.prototype.send = function(data, options, cb) {
...
Sender$1.prototype.close = function(code, data, mask, cb) {
  if (this.isClosed) return;
  this.isClosed = true;
  try {
...
Sender$1.prototype.ping = function(data, options) {};
...
Sender$1.prototype.pong = function(data, options) {};
...
Sender$1.prototype.error = function (reason) {
...
function Receiver$1 () {
  if (this instanceof Receiver$1 === false) {
    throw new TypeError("Classes can't be function-called");
  }
...
Receiver$1.prototype.add = function(data) {
  if (this.dead) return;
  var self = this;
  function doAdd() {
    if (self.state === EMPTY) {
...
Receiver$1.prototype.cleanup = function() {
  this.dead = true;
  this.state = EMPTY;
  this.buffers = [];
};
...
Receiver$1.prototype.parse = function() {
...
Receiver$1.prototype.error = function (reason, terminate) {
  if (this.dead) return;
  this.reset();
  if(typeof reason == 'string'){
...
Receiver$1.prototype.reset = function (reason) {
  if (this.dead) return;
  this.state = EMPTY;
  this.buffers = [];
  this.messageEnd = -1;
 ...
 * Inherits from EventEmitter.
 */
util.inherits(WebSocket, EventEmitter$2);
...
var buildHostHeader_1 = buildHostHeader;
 ...
 */
function initAsServerClient(req, socket, upgradeHead, options$1) {
  ...
  this.protocol = options$1.value.protocol;
  this.protocolVersion = options$1.value.protocolVersion;
  this.extensions = options$1.value.extensions;
  this.supports.binary = (this.protocolVersion !== 'hixie-76');
  this.upgradeReq = req;
  this.readyState = WebSocket.CONNECTING;
  this._isServer = true;
  this.maxPayload = options$1.value.maxPayload;
  // establish connection
  if (options$1.value.protocolVersion === 'hixie-76') {
    establishConnection.call(this, Receiver_hixie, Sender_hixie, socket, upgradeHead);
  } else {
    establishConnection.call(this, Receiver_1, Sender_1, socket, upgradeHead);
  }
}

function initAsClient(address, protocols, options$1) {
  options$1 = new options({
    origin: null,
    protocolVersion: protocolVersion,
    host: null,
  ...
  if (options$1.value.protocolVersion !== 8 && options$1.value.protocolVersion !== 13) {
    throw new Error('unsupported protocol version');
  }

  // verify URL and establish http class
  var serverUrl = url$1.parse(address);
  ...
  if (options$1.value.perMessageDeflate) {
    perMessageDeflate = new PerMessageDeflate_1(typeof options$1.value.perMessageDeflate !== true ? options$1.value.perMessageDeflate : {}, false);
  ...
  // begin handshake
  var key = new Buffer(options$1.value.protocolVersion + '-' + Date.now()).toString('base64');
  var shasum = crypto.createHash('sha1');
  shasum.update(key + '258EAFA5-E914-47DA-95CA-C5AB0DC85B11');
  var expectedServerKey = shasum.digest('base64');

  var agent = options$1.value.agent;
  ...
  var requestOptions = {
    ...
    headers: {
      ...
      'Upgrade': 'websocket',
      'Host': headerHost,
      'Sec-WebSocket-Version': options$1.value.protocolVersion,
  ...
  if (options$1.value.protocol) {
    requestOptions.headers['Sec-WebSocket-Protocol'] = options$1.value.protocol;
  }

  if (options$1.value.host) {
    requestOptions.headers.Host = options$1.value.host;
  }

  if (options$1.value.headers) {
    for (var header in options$1.value.headers) {
       if (options$1.value.headers.hasOwnProperty(header)) {
        requestOptions.headers[header] = options$1.value.headers[header];
       }
    }
  }
  ...
  if (options$1.isDefinedAndNonNull('pfx')
   || options$1.isDefinedAndNonNull('key')
   || options$1.isDefinedAndNonNull('passphrase')
   || options$1.isDefinedAndNonNull('cert')
   || options$1.isDefinedAndNonNull('ca')
   || options$1.isDefinedAndNonNull('ciphers')
   || options$1.isDefinedAndNonNull('rejectUnauthorized')) {

    if (options$1.isDefinedAndNonNull('pfx')) requestOptions.pfx = options$1.value.pfx;
    if (options$1.isDefinedAndNonNull('key')) requestOptions.key = options$1.value.key;
    if (options$1.isDefinedAndNonNull('passphrase')) requestOptions.passphrase = options$1.value.passphrase;
    if (options$1.isDefinedAndNonNull('cert')) requestOptions.cert = options$1.value.cert;
    if (options$1.isDefinedAndNonNull('ca')) requestOptions.ca = options$1.value.ca;
    if (options$1.isDefinedAndNonNull('ciphers')) requestOptions.ciphers = options$1.value.ciphers;
    if (options$1.isDefinedAndNonNull('rejectUnauthorized')) requestOptions.rejectUnauthorized = options$1.value.rejectUnauthorized;
  ...
  if (options$1.value.localAddress) {
    requestOptions.localAddress = options$1.value.localAddress;
  }

  if (options$1.value.origin) {
    if (options$1.value.protocolVersion < 13) requestOptions.headers['Sec-WebSocket-Origin'] = options$1.value.origin;
    else requestOptions.headers.Origin = options$1.value.origin;
  }
  ...
  req.once('upgrade', function upgrade(res, socket, upgradeHead) {
    ...
    var protList = (options$1.value.protocol || "").split(/, */);
    var protError = null;

    if (!options$1.value.protocol && serverProt) {
      protError = 'server sent a subprotocol even though none requested';
    } else if (options$1.value.protocol && !serverProt) {
    ...
    if (perMessageDeflate && serverExtensions[PerMessageDeflate_1.extensionName]) {
      ...
      self.extensions[PerMessageDeflate_1.extensionName] = perMessageDeflate;
    }

    establishConnection.call(self, Receiver_1, Sender_1, socket, upgradeHead);
...
function establishConnection(ReceiverClass, SenderClass, socket, upgradeHead) {
  var ultron$1 = this._ultron = new ultron(socket)
    , called = false
    , self = this;
  ...
  ultron$1.on('end', cleanupWebsocketResources.bind(this));
  ultron$1.on('close', cleanupWebsocketResources.bind(this));
  ultron$1.on('error', cleanupWebsocketResources.bind(this));
...
WebSocket_1.buildHostHeader = buildHostHeader_1;
...
function WebSocketServer(options$1, callback) {
  if (this instanceof WebSocketServer === false) {
    return new WebSocketServer(options$1, callback);
  }
  ...
  if (!options$1.isDefinedAndNonNull('port') && !options$1.isDefinedAndNonNull('server') && !options$1.value.noServer) {
    throw new TypeError('`port` or a `server` must be provided');
  }

  var self = this;

  if (options$1.isDefinedAndNonNull('port')) {
    ...
    this._server.listen(options$1.value.port, options$1.value.host, callback);
    this._closeServer = function() { if (self._server) self._server.close(); };
  }
  else if (options$1.value.server) {
    this._server = options$1.value.server;
    if (options$1.value.path) {
      // take note of the path, to avoid collisions when multiple websocket servers are
      // listening on the same http server
      if (this._server._webSocketPaths && options$1.value.server._webSocketPaths[options$1.value.path]) {
        throw new Error('two instances of WebSocketServer cannot listen on the same http server path');
      }
      if (typeof this._server._webSocketPaths !== 'object') {
        this._server._webSocketPaths = {};
      }
      this._server._webSocketPaths[options$1.value.path] = 1;
    }
  }
  if (this._server) {
  ...
  this.options = options$1.value;
  this.path = options$1.value.path;
  this.clients = [];
}
...
function handleHybiUpgrade(req, socket, upgradeHead, cb) {
  ...
  var completeHybiUpgrade2 = function(protocol) {
    ...
    var client = new WebSocket_1([req, socket, upgradeHead], {
    ...
    var completeHandshake = function(nonce, rest, headerBuffer) {
      ...
      try {
        ...
        socket.write(handshakeBuffer, 'binary', function(err) {
          ...
          var client = new WebSocket_1([req, socket, rest], {
...
function acceptExtensions(offer) {
  ...
  if (options && offer[PerMessageDeflate_1.extensionName]) {
    var perMessageDeflate = new PerMessageDeflate_1(options !== true ? options : {}, true, maxPayload);
...
var ws = createCommonjsModule(function (module) {
...
var WS = module.exports = WebSocket_1;

WS.Server = WebSocketServer_1;
WS.Sender = Sender_1;
WS.Receiver = Receiver_1;
...
var debug$5 = debug$2('engine.io-client:websocket');
...
WS.prototype.doOpen = function () {
  ...
  try {
    this.ws = this.usingBrowserWebSocket ? new WebSocket$1(uri) : new WebSocket$1(uri, protocols, opts);
  } catch (err) {
...
var debug$6 = debug$2('engine.io-client:socket');
...
var debug$7 = debug('socket.io-client:manager');
...
(function(){
  var iceServers, EventEmitter, io, PeerNetwork, Peer, out$ = exports || this;
  iceServers = [
    {
